...
//   const localTime = new Date(utcTime + 3600000 * 0); // Assume UTC for server time
//   return localTime.toISOString(); // ISO string for easy parsing
// }
...
export default async function Home() {
  ...
  return (
    <main className="relative flex justify-center items-center flex-col">
      ...
      <HomePage clientTimeOffset={getClientOffset()}/>
      <Skills />
      <Work />
      <About />
      <Testimonial />
