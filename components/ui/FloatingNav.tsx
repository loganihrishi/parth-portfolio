      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <Link
            ...
            href={navItem.link}
            className={cn(
              "relative h-[35px] w-16 font-libre font-normal text-[11px] dark:text-neutral-50 items-center justify-center flex text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500"
            )}
          >
