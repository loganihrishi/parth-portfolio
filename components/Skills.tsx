  ...
  return (
    <section className="relative bg-[#161617] h-full w-full flex flex-col">
      <div className="bg-white dark:bg-[#111113] h-full mx-6 pt-20 flex items-center justify-center">
        <div className='absolute top-[90px] font-bluu text-5xl text-[#1C2024] dark:text-[#EDEEF0]'>Some of my skills</div>
    ...
    <motion.div
      ref= {ref}
      className="skills-wrapper relative flex flex-row gap-8 justify-around w-[1280px] h-full py-[120px]"
    >
      <motion.div
        className="flex items-center justify-center h-[484px] basis-1/4"
      ...
      <motion.div
        className="flex items-center justify-center h-[484px] basis-1/4"
        initial={{ rotateX: 50, opacity: 0.5 }}
