...
const Skills = () => {
  ...
  return (
    <section className="relative bg-[#161617] h-[594px] w-full flex flex-col">
      <div className="bg-white dark:bg-[#111113] h-full mx-6 flex items-center justify-center">
        <div className='skills relative flex flex-row gap-8 justify-around w-[1280px] h-full py-[55px]'>
